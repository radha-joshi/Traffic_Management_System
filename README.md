...
A comprehensive traffic management system that creates "Green Corridors" for emergency vehicles by dynamically controlling traffic signals along predefined routes. Built with pure Python HTTP server (no Flask), React frontend, and MySQL database.
...
- **frontend/**: React-based modern web dashboard for monitoring and control
